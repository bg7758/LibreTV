// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["dyttzy","ruyi","bfzy","ffzy","xiaomaomi","tyyszy","heimuer","wolong","hwba","jisu"]'); // 默认选中资源 其他的 ,"jisu","dbzy","mozhua","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun"
