// 全局变量
let selectedAPIs = JSON.parse(localStorage.getItem('selectedAPIs') || '["tyyszy","bfzy","dyttzy","ffzy","ruyi","heimuer","zy360","iqiyi","wolong","hwba"]'); // 默认选中资源 其他的 ,"jisu","dbzy","mozhua","mdzy","zuid","yinghua","baidu","wujin","wwzy","ikun"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    if (!localStorage.getItem('hasInitializedDefaults')) {
        // 默认选中资源
        selectedAPIs = ["tyyszy","bfzy","dyttzy","ffzy","ruyi","heimuer","zy360","iqiyi","wolong","hwba"];
